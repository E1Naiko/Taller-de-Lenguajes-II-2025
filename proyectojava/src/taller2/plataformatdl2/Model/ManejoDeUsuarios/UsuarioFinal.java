...
public class UsuarioFinal extends Usuario {
    ...
    */
    ...
    /**
    * Devuelve una representación en cadena del UsuarioFinal, mostrando sus datos personales
    * y preferencias como idioma, géneros favoritos, lista preferida e historial de reproducción.
    * 
    * @return Una cadena con toda la información relevante del usuario final.
    */
    @Override
